// Tuples
// 
// A Tuple is a collection of different types of values. Tuples are constructed using parentheses
...
fn main() {
    ...
    // TODO ^ Uncomment the above two lines to see the compiler error
    ...
    println!("One elemenr tuple: {:?}", (5u32,));
...
//    switch from pringint the debug format {:?} to the display format {} you see the following
//    output: 
// ( 1.1 1.2 )
// ( 2.1 2.2 )
