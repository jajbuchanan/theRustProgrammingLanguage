...
// a two-word object; the first word is a pointer to the data, the second word the length of the
// slice. The word size is the same as usize, determined by the processor architecture, e.g. 64
...
fn main() {
    ...
    // as shown below, or used with `.expect()` if you would like the program to exit with a nice
